...
class PropertyOrLandNavigator extends Navigator {
  ...
  override protected def route(draftId: String): PartialFunction[Page, AffinityGroup => UserAnswers => Call] = {
    case page @ PropertyOrLandAddressYesNoPage(index)   =>
      _ =>
        ua =>
          yesNoNav(
            ua = ua,
    ...
    case page @ PropertyOrLandAddressUkYesNoPage(index) =>
      _ =>
        ua =>
          yesNoNav(
            ua = ua,
    ...
    case PropertyOrLandInternationalAddressPage(index)  =>
      _ => _ => PropertyOrLandTotalValueController.onPageLoad(index, draftId)
    case PropertyOrLandTotalValuePage(index)            =>
      _ => _ => TrustOwnAllThePropertyOrLandController.onPageLoad(index, draftId)
    case page @ TrustOwnAllThePropertyOrLandPage(index) =>
      _ =>
        ua =>
          yesNoNav(
            ua = ua,
