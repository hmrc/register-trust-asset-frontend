...
class PartnershipAssetMapperSpec extends SpecBase with Matchers with OptionValues with Generators {
  ...
  "PartnershipAssetMapper" must {
    ...
    "must not be able to create a partnership asset when no description or start date in user answers" in {
      ...
      val userAnswers =
        emptyUserAnswers
          .set(WhatKindOfAssetPage(0), WhatKindOfAsset.Partnership)
          .success
          .value
    ...
    "must able to create a Partnership Asset" in {
      ...
      val userAnswers =
        emptyUserAnswers
          ...
          .success
          .value
          .set(PartnershipStartDatePage(0), LocalDate.now)
          .success
          .value
      ...
      partnershipAssetMapper.build(userAnswers).value mustBe List(
        PartnershipType("Partnership Description", LocalDate.now)
      )
    }
    ...
    "must able to create multiple Partnership Assets" in {
      ...
      val userAnswers =
        emptyUserAnswers
          ...
          .success
          .value
          .set(PartnershipDescriptionPage(0), "Partnership Description 1")
          .success
          .value
          .set(PartnershipStartDatePage(0), LocalDate.now)
          .success
          ...
          .success
          .value
          .set(WhatKindOfAssetPage(1), WhatKindOfAsset.Partnership)
          .success
          .value
          .set(PartnershipDescriptionPage(1), "Partnership Description 2")
          .success
          .value
          .set(PartnershipStartDatePage(1), LocalDate.now)
          .success
          .value
