...
class WhatKindOfAssetPageSpec extends PageBehaviours {
  ...
  "remove money when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(AssetMoneyValuePage(0), num)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
        .value
  ...
  "remove share portfolio data when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        ...
        .success
        .value
        .set(SharePortfolioNamePage(0), str)
        .success
        .value
        .set(SharePortfolioOnStockExchangePage(0), true)
        .success
        .value
        .set(SharePortfolioQuantityInTrustPage(0), num)
        .success
        .value
        .set(SharePortfolioValueInTrustPage(0), num)
        .success
        .value
        .set(ShareCompanyNamePage(0), str)
        .success
        .value
        .set(SharesOnStockExchangePage(0), false)
        .success
        .value
        .set(ShareClassPage(0), ShareClass.Ordinary)
        .success
        .value
        .set(ShareQuantityInTrustPage(0), num)
        .success
        .value
        .set(ShareValueInTrustPage(0), num)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
  ...
  "remove property or land when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(PropertyOrLandAddressYesNoPage(0), true)
        .success
        .value
        .set(PropertyOrLandAddressUkYesNoPage(0), true)
        .success
        .value
        ...
        .success
        .value
        .set(PropertyOrLandDescriptionPage(0), str)
        .success
        .value
        .set(PropertyOrLandTotalValuePage(0), num)
        .success
        .value
        .set(TrustOwnAllThePropertyOrLandPage(0), false)
        .success
        .value
        .set(PropertyLandValueTrustPage(0), num)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
  ...
  "remove other when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(OtherAssetDescriptionPage(0), str)
        .success
        .value
        .set(OtherAssetValuePage(0), num)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
  ...
  "remove partnership when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(PartnershipDescriptionPage(0), str)
        .success
        .value
  ...
  "remove business when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(BusinessNamePage(0), str)
        .success
        .value
        .set(BusinessDescriptionPage(0), str)
        .success
        .value
        .set(BusinessUkAddressPage(0), ukAddress)
        .success
        .value
        .set(BusinessInternationalAddressPage(0), internationalAddress)
        .success
        .value
        .set(BusinessValuePage(0), num)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
  ...
  "remove non-EEA business when changing type of asset" in {
    ...
    forAll(arbitrary[UserAnswers], kindOfAsset) { (initial, kind) =>
      val answers: UserAnswers = initial
        .set(noneeabusiness.NamePage(0), str)
        .success
        .value
        .set(noneeabusiness.InternationalAddressPage(0), internationalAddress)
        .success
        .value
        .set(noneeabusiness.GoverningCountryPage(0), str)
        .success
        .value
        .set(noneeabusiness.StartDatePage(0), date)
        .success
        .value
        .set(AssetStatus(0), Status.Completed)
        .success
