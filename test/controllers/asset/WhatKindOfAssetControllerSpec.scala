    ...
    "4mld" must {
      ...
      "return OK and the correct view for a GET" in {
        ...
        contentAsString(result) mustEqual
          view(form, fakeDraftId, index, options, isTaxable = true)(request, messages).toString
      ...
      "populate the view correctly on a GET when the question has previously been answered" in {
        ...
        contentAsString(result) mustEqual
          view(form.fill(Shares), fakeDraftId, index, options, isTaxable = true)(request, messages).toString
      ...
      "display Money if the same index is an in progress Money asset" in {
        ...
        contentAsString(result) mustEqual
          view(form.fill(Money), fakeDraftId, index, options, isTaxable = true)(request, messages).toString
      ...
      "not display Money if an in progress or complete Money asset already exists for a different index" when {
        ...
        "it's in progress" in {
          ...
          contentAsString(result) mustEqual
            view(form, fakeDraftId, 1, optionsWithoutMoney, isTaxable = true)(request, messages).toString
      ...
      "return a Bad Request and errors when invalid data is submitted" in {
        ...
        contentAsString(result) mustEqual
          view(boundForm, fakeDraftId, index, options, isTaxable = true)(request, messages).toString
