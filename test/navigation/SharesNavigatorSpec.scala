  ...
  "Shares Navigator" must {
    ...
    "go to SharePortfolioName from SharesInAPortfolio when user answers yes" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        ...
        navigator
          .nextPage(SharesInAPortfolioPage(index), fakeDraftId)(answers)
    ...
    "go to SharePortfolioOnStockExchange from SharePortfolioName" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(SharePortfolioNamePage(index), fakeDraftId)(userAnswers)
    ...
    "go to SharePortfolioQuantityInTrust from SharePortfolioOnStockExchange" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(SharePortfolioOnStockExchangePage(index), fakeDraftId)(userAnswers)
    ...
    "go to SharePortfolioValueInTrust from SharePortfolioQuantityInTrust" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(SharePortfolioQuantityInTrustPage(index), fakeDraftId)(userAnswers)
    ...
    "go to ShareAnswers from SharePortfolioValueInTrust" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(SharePortfolioValueInTrustPage(index), fakeDraftId)(userAnswers)
    ...
    "go to SharesOnStockExchange from ShareCompanyName" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(ShareCompanyNamePage(index), fakeDraftId)(userAnswers)
    ...
    "go to ShareClass from SharesOnStockExchange" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(SharesOnStockExchangePage(index), fakeDraftId)(userAnswers)
    ...
    "go to ShareQuantityInTrust from ShareClass" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(ShareClassPage(index), fakeDraftId)(userAnswers)
    ...
    "go to ShareValueInTrust from ShareQuantityInTrust" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(ShareQuantityInTrustPage(index), fakeDraftId)(userAnswers)
    ...
    "go to ShareAnswers from ShareValueInTrust" in {
      ...
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(ShareValueInTrustPage(index), fakeDraftId)(userAnswers)
          .mustBe(ShareAnswerController.onPageLoad(index, fakeDraftId))
      }
    }
    ...
    "go to AddAssetPage from ShareAnswerPage" in {
      forAll(arbitrary[UserAnswers]) { userAnswers =>
        navigator
          .nextPage(ShareAnswerPage, fakeDraftId)(userAnswers)
