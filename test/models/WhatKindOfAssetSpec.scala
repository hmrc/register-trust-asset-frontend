  ...
  "WhatKindOfAsset" must {
    ...
    "display label in correct language" when {
      ...
      "English" in {
        ...
        result mustBe "Company registered outside UK and EEA (European Economic Area)"
      ...
      "Welsh" in {
        ...
        result mustBe "Cwmnïau sydd wedi’u cofrestru y tu allan i’r DU neu’r AEE (Ardal Economaidd Ewropeaidd)"
      }
    }
  }
}
